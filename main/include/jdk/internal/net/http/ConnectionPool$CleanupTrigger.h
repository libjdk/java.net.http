...
class $import ConnectionPool$CleanupTrigger : public ::jdk::internal::net::http::common::FlowTube$TubeSubscriber, public ::jdk::internal::net::http::common::FlowTube$TubePublisher, public ::java::util::concurrent::Flow$Subscription {
