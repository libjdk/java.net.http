...
class $import ResponseSubscribers$HttpResponseInputStream : public ::java::io::InputStream, public ::jdk::internal::net::http::ResponseSubscribers$TrustedSubscriber {
