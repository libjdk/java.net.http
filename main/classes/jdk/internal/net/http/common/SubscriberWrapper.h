...
class $export SubscriberWrapper : public ::jdk::internal::net::http::common::FlowTube$TubeSubscriber, public ::java::io::Closeable, public ::java::util::concurrent::Flow$Processor {
